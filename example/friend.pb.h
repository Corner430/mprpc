...
PROTOBUF_NAMESPACE_OPEN
template<> ::corner::GetFriendsListRequest* Arena::CreateMaybeMessage<::corner::GetFriendsListRequest>(Arena*);
template<> ::corner::GetFriendsListResponse* Arena::CreateMaybeMessage<::corner::GetFriendsListResponse>(Arena*);
...
class GetFriendsListRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:corner.GetFriendsListRequest) */ {
 public:
...
class GetFriendsListResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:corner.GetFriendsListResponse) */ {
 public:
...
inline const ::corner::ResultCode& GetFriendsListResponse::_internal_result() const {
...
inline void GetFriendsListResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:corner.GetFriendsListResponse.result)
}
...
inline ::corner::ResultCode* GetFriendsListResponse::unsafe_arena_release_result() {
...
inline ::corner::ResultCode* GetFriendsListResponse::_internal_mutable_result() {
...
inline void GetFriendsListResponse::set_allocated_result(::corner::ResultCode* result) {
